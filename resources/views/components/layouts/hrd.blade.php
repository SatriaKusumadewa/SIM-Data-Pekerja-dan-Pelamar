...
<head>
    ...
    <title>{{ $title }} - {{ config('app.name', 'Sistem Informasi Sumber Daya Manusia') }}</title>
    ...
    <div class="min-h-screen w-full overflow-x-hidden">
        ...
        >
            <div class="border-b px-6 py-5">
                <h2 class="text-2xl font-bold text-gray-900">HRD</h2>
            </div>
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <nav class="space-y-3">
                    ...
                    class="block rounded border px-4 py-2 text-base transition
                    {{ request()->routeIs('hrd.data-karyawan.index')
                            || request()->routeIs('hrd.data-karyawan.create')
                            || request()->routeIs('hrd.data-karyawan.edit')
                            || request()->routeIs('hrd.data-karyawan.cetak')
                            || request()->routeIs('hrd.data-karyawan.pdf')
                            || request()->routeIs('hrd.pelamars.proses.*')
                                ? 'border-sky-600 bg-sky-600 text-white'
                                : 'border-gray-100 bg-white text-gray-800 hover:border-sky-600 hover:bg-sky-600 hover:text-white' }}">
                        Data Karyawan
                    </a>
                    ...
                    class="block rounded border px-4 py-2 text-base transition
                    {{ request()->routeIs('hrd.dokumen-karyawan.*')
                            || request()->routeIs('hrd.data-karyawan.dokumen.*')
                                ? 'border-sky-600 bg-sky-600 text-white'
                                : 'border-gray-100 bg-white text-gray-800 hover:border-sky-600 hover:bg-sky-600 hover:text-white' }}">
                        Dokumen Karyawan
                    </a>

                    <a href="{{ route('hrd.pelamars.index') }}"
                    class="block rounded border px-4 py-2 text-base transition
                    {{ request()->routeIs('hrd.pelamars.index')
                            || request()->routeIs('hrd.pelamars.show')
                            || request()->routeIs('hrd.pelamars.edit')
                            || request()->routeIs('hrd.pelamars.create')
                                ? 'border-sky-600 bg-sky-600 text-white'
                                : 'border-gray-100 bg-white text-gray-800 hover:border-sky-600 hover:bg-sky-600 hover:text-white' }}">
                        Data Pelamar
                    </a>
